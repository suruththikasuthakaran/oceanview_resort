                                          ...
                                          <div
                                                 ...
                                                 <div class="bg-ocean p-8 text-white">
                                                        <div class="flex items-center gap-4">
                                                               ...
                                                               <div>
                                                                      <h2 class="text-3xl font-bold tracking-tight">Edit
                                                                             Room Details</h2>
                                                                      <p class="text-sky-100 mt-1">Update specifications
                                                                             for Room #${room.roomNumber}</p>
                                                               </div>
                                                        </div>
                                                 </div>
                                                        ...
                                                        <form action="${pageContext.request.contextPath}/rooms"
                                                               ...
                                                               <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                                                                      ...
                                                                      <div class="space-y-8">
                                                                             ...
                                                                             <div>
                                                                                    <label
                                                                                           class="block text-sm font-bold text-gray-700 mb-3 uppercase tracking-wide">Update
                                                                                           Room Image</label>
                                                                                    <label for="imageFile"
                                                                                           ...
                                                                                           <div id="imagePreview"
                                                                                                  class="absolute inset-0 ${not empty room.image ? '' : 'hidden'} rounded-2xl overflow-hidden pointer-events-none">
                                                                             ...
                                                                             <div>
                                                                                    ...
                                                                                    <textarea name="description"
                                                                                           rows="6"
                                                                                           class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none transition-all shadow-sm bg-gray-50 focus:bg-white resize-none">${room.description}</textarea>
                                                                             </div>
                                                                      </div>
                                                               </div>
