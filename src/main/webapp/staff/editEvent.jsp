<%@ page contentType="text/html;charset=UTF-8" %>
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        ...
        <head>
            ...
            <title>Edit Event Package - Ocean View Resort</title>
                    ...
                    <div class="max-w-4xl w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                        <div class="bg-ocean p-8 text-white">
                            <div class="flex items-center justify-center gap-4">
                                ...
                                <div>
                                    <h2 class="text-3xl font-bold tracking-tight">Edit Event Package</h2>
                                    <p class="text-purple-100 mt-1">Modify your event package details and media.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <form action="${pageContext.request.contextPath}/events" method="post"
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                                    <div class="space-y-6">
                                        ...
                                        <div>
                                            <label
                                                ...
                                                Name</label>
                                            <input name="name" required type="text" value="${event.name}"
                                        ...
                                        <div>
                                            ...
                                            <textarea name="description" rows="5" required
                                                class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all shadow-sm bg-gray-50 focus:bg-white resize-none">${event.description}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div>
                                            <label
                                                class="block text-sm font-bold text-gray-700 mb-3 uppercase tracking-wide">Change
                                                Image</label>
                                            <label for="imageFile"
                                                ...
                                                <div id="imagePreview"
                                                    class="absolute inset-0 rounded-2xl overflow-hidden pointer-events-none ${empty event.image ? 'hidden' : ''}">
                                                    <img src="${not empty event.image ? pageContext.request.contextPath.concat('/').concat(event.image) : ''}"
