<%@ page contentType="text/html;charset=UTF-8" %>
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        ...
        <head>
            ...
            <title>Edit Food Package - Ocean View Resort</title>
                    ...
                    <div class="max-w-4xl w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                        <div class="bg-ocean p-8 text-white">
                            <div class="flex items-center justify-center gap-4">
                                ...
                                <div>
                                    <h2 class="text-3xl font-bold tracking-tight">Edit Food Package</h2>
                                    <p class="text-orange-100 mt-1">Modify the gourmet menu details.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-10">
                            ...
                            <form action="${pageContext.request.contextPath}/foods" method="post"
                                ...
                                <input type="hidden" name="packageId" value="${food.packageId}" />
                                <input type="hidden" name="existingImage" value="${food.image}" />
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                        <div>
                                            <label
                                                ...
                                                Name</label>
                                            <input name="name" required type="text" value="${food.name}"
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="number" step="0.01" name="price" required min="0"
                                                    value="${food.price}" placeholder="0.00"
                                    ...
                                    <div class="mb-6">
                                        <label
                                            ...
                                            Food Image (Leave empty to keep current)
                                        </label>
                                        ...
                                        <p class="text-xs text-gray-500 mt-2">Max size: 5MB. Accepted formats: JPG, PNG.
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="description" rows="5" required
                                            ...
                                            class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition-all shadow-sm bg-gray-50 focus:bg-white resize-none">${food.description}</textarea>
                                    </div>
                                </div>
